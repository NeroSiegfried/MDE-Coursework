 ...
 */
package uk.ac.kcl.inf.nerosiegfried.chessdsl.ide.contentassist.antlr;
...
import uk.ac.kcl.inf.nerosiegfried.chessdsl.ide.contentassist.antlr.internal.InternalChessDSLParser;
...
public class ChessDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ChessDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getCastleAccess().getAlternatives_0_1(), "rule__Castle__Alternatives_0_1");
			builder.put(grammarAccess.getCastleAccess().getAlternatives_1_2(), "rule__Castle__Alternatives_1_2");
			...
			builder.put(grammarAccess.getAnyMoveAccess().getGroup(), "rule__AnyMove__Group__0");
			...
			builder.put(grammarAccess.getAnyMoveAccess().getMoveAssignment_0(), "rule__AnyMove__MoveAssignment_0");
			builder.put(grammarAccess.getAnyMoveAccess().getRemarksAssignment_1_1(), "rule__AnyMove__RemarksAssignment_1_1");
