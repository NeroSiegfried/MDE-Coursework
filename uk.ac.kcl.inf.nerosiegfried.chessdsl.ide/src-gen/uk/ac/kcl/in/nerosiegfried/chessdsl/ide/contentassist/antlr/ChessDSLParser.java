...
public class ChessDSLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ChessDSLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSANMoveAccess().getAlternatives_1(), "rule__SANMove__Alternatives_1");
			builder.put(grammarAccess.getSANCastleAccess().getAlternatives(), "rule__SANCastle__Alternatives");
			builder.put(grammarAccess.getSANPieceAccess().getAlternatives_1(), "rule__SANPiece__Alternatives_1");
			builder.put(grammarAccess.getSANDisambiguationAccess().getAlternatives_1(), "rule__SANDisambiguation__Alternatives_1");
			builder.put(grammarAccess.getSANPromotionAccess().getAlternatives_2(), "rule__SANPromotion__Alternatives_2");
			builder.put(grammarAccess.getSANCheckMarkerAccess().getAlternatives_1(), "rule__SANCheckMarker__Alternatives_1");
			builder.put(grammarAccess.getSANRemarkAccess().getAlternatives_1(), "rule__SANRemark__Alternatives_1");
			...
			builder.put(grammarAccess.getAnyMoveAccess().getGroup_0(), "rule__AnyMove__Group_0__0");
			builder.put(grammarAccess.getAnyMoveAccess().getGroup_0_1(), "rule__AnyMove__Group_0_1__0");
			...
			builder.put(grammarAccess.getSANMoveAccess().getGroup(), "rule__SANMove__Group__0");
			builder.put(grammarAccess.getSANCastleAccess().getGroup_0(), "rule__SANCastle__Group_0__0");
			builder.put(grammarAccess.getSANCastleAccess().getGroup_0_1(), "rule__SANCastle__Group_0_1__0");
			builder.put(grammarAccess.getSANCastleAccess().getGroup_1(), "rule__SANCastle__Group_1__0");
			builder.put(grammarAccess.getSANNormalAccess().getGroup(), "rule__SANNormal__Group__0");
			builder.put(grammarAccess.getSANPieceAccess().getGroup(), "rule__SANPiece__Group__0");
			builder.put(grammarAccess.getSANDisambiguationAccess().getGroup(), "rule__SANDisambiguation__Group__0");
			builder.put(grammarAccess.getSANPromotionAccess().getGroup(), "rule__SANPromotion__Group__0");
			builder.put(grammarAccess.getSANCheckMarkerAccess().getGroup(), "rule__SANCheckMarker__Group__0");
			builder.put(grammarAccess.getSANCaptureAccess().getGroup(), "rule__SANCapture__Group__0");
			builder.put(grammarAccess.getSANRemarkAccess().getGroup(), "rule__SANRemark__Group__0");
			...
			builder.put(grammarAccess.getAnyMoveAccess().getMoveAssignment_0_0(), "rule__AnyMove__MoveAssignment_0_0");
			builder.put(grammarAccess.getAnyMoveAccess().getRemarksAssignment_0_1_1(), "rule__AnyMove__RemarksAssignment_0_1_1");
			builder.put(grammarAccess.getAnyMoveAccess().getAlgebraicmoveAssignment_1(), "rule__AnyMove__AlgebraicmoveAssignment_1");
			...
			builder.put(grammarAccess.getSANMoveAccess().getCastleAssignment_1_0(), "rule__SANMove__CastleAssignment_1_0");
			builder.put(grammarAccess.getSANMoveAccess().getNormalAssignment_1_1(), "rule__SANMove__NormalAssignment_1_1");
			builder.put(grammarAccess.getSANCastleAccess().getSideAssignment_0_1_1(), "rule__SANCastle__SideAssignment_0_1_1");
			builder.put(grammarAccess.getSANCastleAccess().getSideAssignment_1_1(), "rule__SANCastle__SideAssignment_1_1");
			builder.put(grammarAccess.getSANNormalAccess().getPieceAssignment_1(), "rule__SANNormal__PieceAssignment_1");
			builder.put(grammarAccess.getSANNormalAccess().getDisambAssignment_2(), "rule__SANNormal__DisambAssignment_2");
			builder.put(grammarAccess.getSANNormalAccess().getCaptureAssignment_3(), "rule__SANNormal__CaptureAssignment_3");
			builder.put(grammarAccess.getSANNormalAccess().getTargetAssignment_4(), "rule__SANNormal__TargetAssignment_4");
			builder.put(grammarAccess.getSANNormalAccess().getPromotionAssignment_5(), "rule__SANNormal__PromotionAssignment_5");
			builder.put(grammarAccess.getSANNormalAccess().getCheckAssignment_6(), "rule__SANNormal__CheckAssignment_6");
			builder.put(grammarAccess.getSANNormalAccess().getRemarkAssignment_7(), "rule__SANNormal__RemarkAssignment_7");
