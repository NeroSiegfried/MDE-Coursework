...
import uk.ac.kcl.inf.nerosiegfried.chessdsl.chessDSL.ChessDSLFactory;
...
public class ChessDSLPackageImpl extends EPackageImpl implements ChessDSLPackage
{
   ...
   * @see uk.ac.kcl.inf.nerosiegfried.chessdsl.chessDSL.ChessDSLPackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   */
  @Override
  public EAttribute getPlacement_Square()
  {
   ...
   */
  @Override
  public EAttribute getMove_From()
  {
  ...
  {
    return (EReference)castleEClass.getEStructuralFeatures().get(0);
  }
   ...
   */
  @Override
  public EAttribute getEnPassant_Square()
  {
    return (EAttribute)enPassantEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(placementEClass, PLACEMENT__SQUARE);
    ...
    createEAttribute(moveEClass, MOVE__TO);
    ...
    createEAttribute(enPassantEClass, EN_PASSANT__SQUARE);
  ...
  public void initializePackageContents()
  {
    ...
    winEClass.getESuperTypes().add(this.getMethod());
    timeUpEClass.getESuperTypes().add(this.getWin());
    resignEClass.getESuperTypes().add(this.getWin());
    checkmateEClass.getESuperTypes().add(this.getWin());
    drawEClass.getESuperTypes().add(this.getMethod());
    ...
    initEAttribute(getPlacement_Square(), ecorePackage.getEString(), "square", null, 0, 1, Placement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getMovePair_Color1(), this.getPlayer(), null, "color1", null, 0, 1, MovePair.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getMovePair_Color2(), this.getPlayer(), null, "color2", null, 0, 1, MovePair.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getMove_From(), ecorePackage.getEString(), "from", null, 0, 1, Move.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getMove_To(), ecorePackage.getEString(), "to", null, 0, 1, Move.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getEnPassant_Square(), ecorePackage.getEString(), "square", null, 0, 1, EnPassant.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getTimeUp_Player(), this.getPlayer(), null, "player", null, 0, 1, TimeUp.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(resignEClass, Resign.class, "Resign", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getResign_Player(), this.getPlayer(), null, "player", null, 0, 1, Resign.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(checkmateEClass, Checkmate.class, "Checkmate", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getCheckmate_Player1(), this.getPlayer(), null, "player1", null, 0, 1, Checkmate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getCheckmate_Player2(), this.getPlayer(), null, "player2", null, 0, 1, Checkmate.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(drawEClass, Draw.class, "Draw", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getDraw_Player1(), this.getPlayer(), null, "player1", null, 0, 1, Draw.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getDraw_Player2(), this.getPlayer(), null, "player2", null, 0, 1, Draw.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
