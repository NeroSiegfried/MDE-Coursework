  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case ChessDSLPackage.WIN:
      {
        ...
        if (result == null) result = caseMethod(win);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ChessDSLPackage.TIME_UP:
      {
        ...
        if (result == null) result = caseWin(timeUp);
        if (result == null) result = caseMethod(timeUp);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ChessDSLPackage.RESIGN:
      {
        ...
        if (result == null) result = caseWin(resign);
        if (result == null) result = caseMethod(resign);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ChessDSLPackage.CHECKMATE:
      {
        ...
        if (result == null) result = caseWin(checkmate);
        if (result == null) result = caseMethod(checkmate);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case ChessDSLPackage.DRAW:
      {
        ...
        if (result == null) result = caseMethod(draw);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
