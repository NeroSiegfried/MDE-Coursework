 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.inf.nerosiegfried.chessdsl.chessDSL.impl.ResultImpl#getPlayer <em>Player</em>}</li>
 *   <li>{@link uk.ac.kcl.inf.nerosiegfried.chessdsl.chessDSL.impl.ResultImpl#getColor <em>Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ResultImpl extends MinimalEObjectImpl.Container implements Result
{
  ...
  {
    return ChessDSLPackage.Literals.RESULT;
  }
    ...
    if (player != null && player.eIsProxy())
    {
      ...
      if (player != oldPlayer)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ChessDSLPackage.RESULT__PLAYER, oldPlayer, player));
      }
    }
    return player;
  }
  ...
  public void setPlayer(Player newPlayer)
  {
    ...
    player = newPlayer;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChessDSLPackage.RESULT__PLAYER, oldPlayer, player));
  }
  ...
  public void setColor(Color newColor)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ChessDSLPackage.RESULT__COLOR, oldColor, color));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ChessDSLPackage.RESULT__PLAYER:
        if (resolve) return getPlayer();
        return basicGetPlayer();
      case ChessDSLPackage.RESULT__COLOR:
        return getColor();
    }
